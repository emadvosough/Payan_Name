...
namespace FuzzySystem
{
    ...
    public class FuzzySystem
    {
        ...
        private static List<FuzzySystem> allRegisteredFuzzyLogics = new List<FuzzySystem>();
        ...
        public static FuzzySystem GetRegisteredFuzzyLogic(string guid)
        {
        ...
        public static FuzzySystem GetRegisteredFuzzyLogic(int index)
        {
        ...
        public static bool RegisterFuzzyLogic(FuzzySystem fuzzyLogic)
        {
            if (fuzzyLogic == null)
            {
                return false;
        ...
        public static bool UnregisterFuzzyLogic(FuzzySystem fuzzyLogic)
        {
            if (fuzzyLogic == null)
            {
                return false;
        ...
        public static bool QueryFuzzyLogic(string guid, out FuzzySystem fuzzyLogic)
        {
            fuzzyLogic = null;
            foreach (var item in allRegisteredFuzzyLogics)
            {
        ...
        public static bool IsCycleReference(FuzzySystem fuzzyLogic)
        {
            return IsCycleReference_Internal(fuzzyLogic, fuzzyLogic.guid);
        }

        private static bool IsCycleReference_Internal(FuzzySystem fuzzyLogic, string guid)
        {
            if (fuzzyLogic == null)
            {
                return false;
        ...
        public static byte[] Serialize(FuzzySystem fuzzyLogic)
        {
            if (fuzzyLogic == null)
            {
                return null;
        ...
        public static FuzzySystem Deserialize(byte[] bytes, FuzzySystem overwriteFuzzyLogic)
        {
            if (bytes == null || bytes.Length < header.Length)
            {
                return null;
            ...
            else
            {
                ...
                FuzzySystem fuzzyLogic = overwriteFuzzyLogic;
                if (overwriteFuzzyLogic == null)
                {
                    fuzzyLogic = JsonUtility.FromJson<FuzzySystem>(json);
        ...
        public FuzzySystem(string guid)
        {
            this.guid = guid;
        }

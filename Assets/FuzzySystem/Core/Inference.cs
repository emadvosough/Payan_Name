...
namespace FuzzySystem
{
    ...
    public class Inference
    {
        ...
        private FuzzySystem _fuzzyLogic = null;
        public FuzzySystem fuzzyLogic
        {
            get
            {
                return _fuzzyLogic;
        ...
        */
        ...
        private float OneSideOutput(string guid)
        {
            ...
            else if(FuzzySystem.IsRegisteredFuzzyLogic(guid))
            {
                return FuzzySystem.GetRegisteredFuzzyLogic(guid).Output();
            }
            else
            {
                return 0;
